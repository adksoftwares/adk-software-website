          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
                <div className="w-32 sm:w-40 aspect-[4/5] rounded-[2rem] border-2 border-cyan-500/20 shrink-0 shadow-[0_0_20px_rgba(6,182,212,0.15)] overflow-hidden">
                   <img src="/founder.jpg" alt="S. Arikarran" className="w-full h-full object-cover object-top" />
                </div>
                <div>
