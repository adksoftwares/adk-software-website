...
const Footer = () => {
  return (
    <footer className="bg-[#050505] text-neutral-500 pt-24 pb-12 border-t border-white/[0.06]">
            ...
            <div>
              <Link to="/" className="flex items-center gap-3 mb-6 inline-flex">
                ...
                <div className="flex flex-col justify-center">
                  <span className="font-bold text-lg text-white leading-none tracking-wide mb-1" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>ADK</span>
                  <span className="text-[10px] text-amber-400 font-medium tracking-[0.15em] uppercase leading-none">Software Solutions</span>
                </div>
              </Link>
              <p className="text-neutral-500 max-w-sm leading-relaxed mt-4">
